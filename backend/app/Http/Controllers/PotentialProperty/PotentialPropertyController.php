...
class PotentialPropertyController extends Controller {
    ...
    /*
     * Registrar archivos de cedula y certificado de tradicion
     */

    public function saveFiles(Request $request) {

        //--- Validar que existe el predio potencial ---//

        $potentialProperty = CvPotentialProperty::find($request->potential_property_id);
        ...
        //--- Controlado general de los archivos ---//
        ...
        if (is_array($arrayFiles) && !empty($arrayFiles)) {
            ...
            foreach ($arrayFiles as $file) {
                ...
                if ($saveFile->save()) {
                    ...
                    $pivotFile = new CvPotentialPropertyByFile();
                    $pivotFile->file_id = $saveFile->id;
                    $pivotFile->potential_property_id = $request->potential_property_id;
                    $pivotFile->type_file = $request->type_file;
            ...
            //--- Validar si se agregan nuevos documentos cuando el predio potencial ya ha sido validado ---//
            if ($stateSaveFile == true) {
                $this->changeSubTypePotentialFilesPropertyApproved($potentialProperty->id);
            }
